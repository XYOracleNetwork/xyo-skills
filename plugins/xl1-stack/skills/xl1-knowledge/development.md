...
| react-chain | `@xyo-network/react-chain-client` | React dApp integration (gateway, wallet, hooks) |
...
import { WalletGatewayProvider, ConnectAccountsStack, useProvidedGateway } from '@xyo-network/react-chain-client'
