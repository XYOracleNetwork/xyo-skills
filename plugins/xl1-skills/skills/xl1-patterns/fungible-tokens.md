...
Three narrow schemas under `network.xyo.ordinal.token.*`. Narrow schemas keep Zod types sharp, datalake filtering surgical, and the indexer's discriminated union exhaustive.
